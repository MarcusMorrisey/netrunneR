...
APT_INSTALL := apt-get update -qq && apt-get install -y --no-install-recommends -qq curl git libgit2-dev libsqlite3-dev libcurl4-openssl-dev libicu-dev libxml2-dev libx11-dev libuv1-dev > /dev/null
